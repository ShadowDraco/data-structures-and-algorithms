...
const countNumberOfChildren = (arr) => {
  return arr.reduce((acc, character) => {
    character.children ? acc + Object.keys(character.children).length : acc;
  }, 0);
};
...
const calculateAverage = (arr) => {
  ...
  let calculated = calculator.sum / calculator.count;
  return calculated;
};
