...
const findHappiness = (arr) => {
  let smiles = [];
  arr.reduce((acc, string) => {
    string.match(/(:\))/g) ? smiles.push(string) : acc;
  }, smiles);
...
const findEvery = (arr, target) => {
  // every string has this but regex doesn't notice it maybe?
